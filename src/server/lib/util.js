...
exports.getJackpot = x => x > 39453 ? Math.pow(x - 26302, 0.85) + 26302 : x / 1.5;
...
exports.warn = text => {
	console.log('[' + (exports.time() / 1000).toFixed(3) + ']: ' + '[33m[WARN][0m ' + text);
	logger.warn(text);
};
exports.info = text => {
	console.log('[' + (exports.time() / 1000).toFixed(3) + ']: ' + '[36m[INFO][0m ' + text);
	logger.warn(text);
};
exports.error = text => {
	console.log(text);
